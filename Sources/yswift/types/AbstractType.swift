...
public class AbstractType: JSHashable {
    ...
    public func callObservers(transaction: Transaction, event: EventType) throws {
        var type = self
    ...
    @discardableResult
    public func observe(_ f: @escaping (EventType, Transaction) throws -> Void) -> EventHandler.Disposer {
